...
const Header = () => {
  const { mobileMenu, setMobileMenu, theme, setTheme } =
  ...
  return (
    <div className="flex flex-row h-14 px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      ...
      <div className="group flex items-center">
        ...
        <button className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border border-l-0 border-[#404040] rounded-r-3xl bg-black/[0.1] dark:bg-white/[0.15]">
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <Link to={"https://github.com/Midas847"}>
            <img
              src="https://avatars.githubusercontent.com/u/44649707?v=4"
              alt="Midas"
            />
          </Link>
        </div>
